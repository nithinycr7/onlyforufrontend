...
import styles from '../../create/services.module.css';
...
export default function EditServicePage() {
    ...
    useEffect(() => {
        const fetchService = async () => {
            try {
                const response = await api.get(`/creator/services/${serviceId}`);
                ...
                setFormData({
                    ...
                    price_inr: service.price_inr || 999,
                    response_modes: service.response_modes || ['voice'],
                    features: service.features && service.features.length > 0 ? service.features : [''],
                    sla_hours: service.sla_hours || 48,
                    includes_followups: service.includes_followups || false,
                    max_followups: service.max_followups || 0,
                    followup_window_days: service.followup_window_days || 7,
                    max_slots_per_month: service.max_slots_per_month,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await api.put(`/creator/services/${serviceId}`, {
                ...formData,
